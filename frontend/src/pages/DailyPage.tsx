    ...
    <div className="space-y-6">
      ...
      {planBlocks.length > 0 && (
        <section className="space-y-2">
          <h2 className="flex items-center gap-1.5 text-sm font-semibold uppercase tracking-wide text-violet-700">
          ...
          <ul className="space-y-2">
            {planBlocks.map((block) => {
              ...
              return (
                ...
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/70 text-violet-700">
      ...
      <section className="space-y-3">
        ...
        {tasks.length === 0 && !isLoading && !showAdd && (
          <div className="rounded-2xl border border-dashed border-border/80 bg-card/40 p-6 text-center text-sm text-muted-foreground">
            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  logged ? "border-emerald-200/80 bg-emerald-50/60" : "border-border/80",
                )}
              >
                <div
                  className={cn(
                    "flex h-9 w-9 items-center justify-center rounded-xl",
                    logged ? "bg-emerald-100 text-emerald-700" : "bg-orange-100 text-orange-700",
                  )}
                >
